...
public class CardDemandaPonta extends BasePage {
	...
	public String CardDemandaPonta () throws InterruptedException {
		 
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//section[@class = 'f-card demand-widget p--base br--base m-- color--background--white color--text--font-base'])[1]")));
		Thread.sleep(1000);
	...
	public void LerArquivoTXT () {
		...
		LerArquivoTXT(TestCardDemandaPonta.BugArquivoTXT);
