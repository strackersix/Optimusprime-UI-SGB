...
public class GraficoPerfilCarga extends BasePage {
	...
	public void Go () throws InterruptedException {
		...
		Assert.assertEquals("01/11 0…", PerfilCargaDia1());
		Assert.assertEquals("07/11 21:15", PerfilCargaDia7());
	...
	public void BugArquivoTXT () {
		...
		LerArquivoTXT(TestGraficoPerfilCarga.BugArquivoTXT);
	}
