...
public class CardConsumoTotal extends BasePage {
...
//			robot.keyRelease(KeyEvent.VK_D);
	...
	public String CardConsumoTotal () throws InterruptedException {
		 
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//section[@class = 'f-card intake-card p--base br--base m-- color--background--secondary color--text--font-base intake-card--total']")));
		Thread.sleep(1000);
	...
	public void BugArquivoTXT () {
		...
		LerArquivoTXT(TestCardConsumoTotal.BugArquivoTXT);
