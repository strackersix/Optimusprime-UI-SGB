...
public class CardConsumoForaPonta  extends BasePage {
...
//			robot.keyRelease(KeyEvent.VK_D);
	...
	public String CardConsumoForaPonta () throws InterruptedException {
		 
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//section[@class = 'f-card intake-card p--base br--base m-- color--background--white color--text--font-base'])[2]")));
		Thread.sleep(1000);
	...
	public void LerBugArquivoTXT () {
		
		LerArquivoTXT(TestCardConsumoForaPonta.BugArquivoTXT);
