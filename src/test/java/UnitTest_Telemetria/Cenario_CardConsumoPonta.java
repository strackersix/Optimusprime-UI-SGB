...
import Telemetria.CardConsumoPonta;
import _CORE.DriverFactory;

import org.junit.Assert;

public class Cenario_CardConsumoPonta extends DriverFactory {
	
	Framework login = new Framework();
	CardConsumoPonta cardConsumoPonta = new CardConsumoPonta();
	...
	public void Unit() {
		...
		try {
			...
			String ValorAtual = driver.findElement(By.xpath("(//section[@class = 'f-card intake-card p--base br--base m-- color--background--white color--text--font-base'])[1]")).getText();
